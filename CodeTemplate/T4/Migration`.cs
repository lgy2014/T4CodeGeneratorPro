...
{
    public partial class Migration:IGenerator
    {
        ...
        public Migration(string tableName, string nameSpace, string prefix)
        {
            NameSpace=nameSpace;
            ...
            ClassName = string.Format("_{0}_{1}_Initialize", time.ToString("yyyyMMddHHmmss"), notPrefix);
        ...
        public Migration(string tableName) : this(tableName, "MyNameSpace",null) { }
