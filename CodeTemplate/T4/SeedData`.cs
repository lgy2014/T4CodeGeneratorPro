...
{
    public partial class SeedData:IGenerator
    {
        ...
        public SeedData(string tableName, string nameSpace, string prefix)
        {
            NameSpace = nameSpace;
            ...
            ClassName = string.Format("_{0}_{1}_SeedData", time.ToString("yyyyMMddHHmmss"), notPrefix);
        ...
        public SeedData(string tableName) : this(tableName, "MyNameSpace",null) { }
